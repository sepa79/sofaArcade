...
export const UI_COPY = {
  pl: {
    ...
    rulesTooltips: {
      ...
      royalistAttitude: 'Okresla wspolprace lub wrogosc krolewskich wobec rodow graczy.',
      royalistGrowth: 'Miesieczny przyrost sil w prowincjach krolewskich.',
      royalistInvestment: 'Czesc zasobow krolewskich przeznaczana na wsie i fortyfikacje.',
      royalistDistribution: 'Sposob rozlozenia prowincji krolewskich na poczatku gry.',
    ...
    neutral: 'Neutralna',
    playerNameRequired: 'Kazdy gracz musi miec niepusta nazwe.',
  ...
  en: {
    ...
    rulesTooltips: {
      ...
      royalistAttitude: 'Controls royalist cooperation or hostility toward player houses.',
      royalistGrowth: 'Monthly force growth in royalist provinces.',
      royalistInvestment: 'Share of royalist resources spent on villages and fortifications.',
      royalistDistribution: 'How royalist provinces are distributed at the start of the game.',
    ...
    neutral: 'Neutral',
    playerNameRequired: 'Every player must have a non-empty name.',
